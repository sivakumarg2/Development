(function () {
  ...
  Implementation.$inject = ['$rootScope', '$scope', '$location', '$log', '$window','UserApi', 'IdeaService', '$stateParams', '$filter'];

  function Implementation($rootScope, $scope, $location, $log, $window, UserApi, IdeaService, $stateParams, $filter) {
